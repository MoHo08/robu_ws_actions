...
#include "robu_interfaces/action/detail/fibonacci__rosidl_typesupport_fastrtps_c.h"
...
using _Fibonacci_Goal__ros_msg_type = robu_interfaces__action__Fibonacci_Goal;
...
static uint32_t _Fibonacci_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robu_interfaces__action__Fibonacci_Goal;
    is_plain =
      (
...
static size_t _Fibonacci_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_Goal(
...
using _Fibonacci_Result__ros_msg_type = robu_interfaces__action__Fibonacci_Result;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_Result(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces__action__Fibonacci_Result;
    is_plain =
      (
...
static size_t _Fibonacci_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_Result(
    full_bounded, is_plain, 0);
...
using _Fibonacci_Feedback__ros_msg_type = robu_interfaces__action__Fibonacci_Feedback;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_Feedback(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces__action__Fibonacci_Feedback;
    is_plain =
      (
...
static size_t _Fibonacci_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_Feedback(
    full_bounded, is_plain, 0);
...
// already included above
// #include "robu_interfaces/action/detail/fibonacci__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robu_interfaces, action, Fibonacci_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_robu_interfaces
...
using _Fibonacci_SendGoal_Request__ros_msg_type = robu_interfaces__action__Fibonacci_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robu_interfaces, action, Fibonacci_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_robu_interfaces__action__Fibonacci_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_SendGoal_Request(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robu_interfaces__action__Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces__action__Fibonacci_SendGoal_Request;
    is_plain =
      (
...
static size_t _Fibonacci_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_SendGoal_Request(
    full_bounded, is_plain, 0);
...
using _Fibonacci_SendGoal_Response__ros_msg_type = robu_interfaces__action__Fibonacci_SendGoal_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_SendGoal_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces__action__Fibonacci_SendGoal_Response;
    is_plain =
      (
...
static size_t _Fibonacci_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_SendGoal_Response(
    full_bounded, is_plain, 0);
...
using _Fibonacci_GetResult_Request__ros_msg_type = robu_interfaces__action__Fibonacci_GetResult_Request;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_GetResult_Request(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces__action__Fibonacci_GetResult_Request;
    is_plain =
      (
...
static size_t _Fibonacci_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_GetResult_Request(
    full_bounded, is_plain, 0);
...
// already included above
// #include "robu_interfaces/action/detail/fibonacci__functions.h"  // result
...
using _Fibonacci_GetResult_Response__ros_msg_type = robu_interfaces__action__Fibonacci_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robu_interfaces, action, Fibonacci_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_robu_interfaces__action__Fibonacci_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_GetResult_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robu_interfaces__action__Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces__action__Fibonacci_GetResult_Response;
    is_plain =
      (
...
static size_t _Fibonacci_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_GetResult_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "robu_interfaces/action/detail/fibonacci__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Fibonacci_FeedbackMessage__ros_msg_type = robu_interfaces__action__Fibonacci_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, robu_interfaces, action, Fibonacci_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_robu_interfaces__action__Fibonacci_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robu_interfaces__action__Fibonacci_FeedbackMessage(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_robu_interfaces__action__Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces__action__Fibonacci_FeedbackMessage;
    is_plain =
      (
...
static size_t _Fibonacci_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robu_interfaces__action__Fibonacci_FeedbackMessage(
    full_bounded, is_plain, 0);
