...
#include "robu_interfaces/action/detail/fibonacci__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robu_interfaces::action::Fibonacci_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_robu_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<robu_interfaces::action::Fibonacci_Goal>()
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces::action::Fibonacci_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces::action::Fibonacci_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
// functions for robu_interfaces::action::Fibonacci_Goal already declared above
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  robu_interfaces::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
  ...
  robu_interfaces::action::Fibonacci_SendGoal_Request & ros_message)
{
  ...
  // Member: goal
  robu_interfaces::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    robu_interfaces::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robu_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces::action::Fibonacci_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces::action::Fibonacci_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces::action::Fibonacci_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for robu_interfaces::action::Fibonacci_Result already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robu_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces::action::Fibonacci_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
// functions for robu_interfaces::action::Fibonacci_Feedback already declared above
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robu_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = robu_interfaces::action::Fibonacci_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robu_interfaces::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<robu_interfaces::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &robu_interfaces::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
